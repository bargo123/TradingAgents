"""One-shot, read-only HOLD outcome audit for a forex shadow database."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="forex_hold_audit",
        description="Read-only realized-outcome audit for persisted HOLD decisions.",
    )

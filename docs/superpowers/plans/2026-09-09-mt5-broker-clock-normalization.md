...
- [x] **Step 2: Run the broker-clock tests and verify the expected failures**
...
- [x] **Step 3: Implement the pure decoder, model, candidate search, and errors**
...
- [x] **Step 4: Run the broker-clock tests green**

  Run `pytest tests/test_mt5_broker_clock.py -q` and confirm all new cases pass.

- [x] **Step 5: Commit the standalone clock contracts**
...
- [x] **Step 2: Run the provider tests red**
...
- [x] **Step 3: Implement provider calibration and centralized normalization**
...
- [x] **Step 4: Normalize all incoming timestamped data**
...
- [x] **Step 1: Write failing historical/provenance tests**
...
- [x] **Step 3: Implement inverse range translation and JSON provenance**
...
- [x] **Step 5: Commit historical/provenance integration**
...
- [x] **Step 1: Run calibration with no TradingAgents/LLM construction**
...
- [x] **Step 2: Verify outgoing range translation experimentally**
...
- [x] **Step 3: Require the fail-closed acceptance gate**
...
- [x] **Step 2: Run exactly one `forex-watch once` only after the acceptance gate**
...
- [x] **Step 3: Stop on any new defect**

...
def calculator():
    rows = (
        ...
        _record("hold-exp", snapshots=(_complete(
            "hold", selected_action="HOLD", selected_action_net_points=0.0,
            buy_net_points=4.0, sell_net_points=-3.0,
            hold_opportunity_cost_points=0.0),)),
        _record("exp-recovered", snapshots=(_complete(
            "recovered", recovered_from_unavailable_at="2026-01-02T15:00:00Z",
            evaluated_at="2026-01-02T15:00:00Z"),)),
        _record("exp-with-prior", snapshots=(
            {**_complete("prior", evaluation_status="DATA_UNAVAILABLE",
                         evaluated_at="2026-01-02T13:00:00Z",
                         unavailable_reason="NO_QUOTES")},
            _complete("later", evaluated_at="2026-01-02T15:00:00Z",

...
from .errors import SourceDatabaseUnavailableError, SourceSchemaIncompatibleError, SourceSnapshotChangedError
from .identity import source_snapshot_fingerprint

_DECISION_COLUMNS = {
    "decision_id", "created_at", "analysis_date", "source_run_id", "requested_symbol", "resolved_symbol",
    "analysis_profile", "analysis_timeframe", "valid_for_seconds", "valid_until", "action",
    "normalization_status", "decision_context_status", "llm_provider", "quick_model", "deep_model",
    "snapshot_timestamp", "analysis_snapshot_timestamp", "analysis_snapshot_bid", "analysis_snapshot_ask",
    "analysis_snapshot_spread", "analysis_snapshot_spread_points", "decision_completed_timestamp",
    "decision_reference_timestamp", "decision_reference_status", "snapshot_json", "executed",
    "normalization_error", "raw_portfolio_manager_result", "trader_summary",
    "portfolio_manager_summary", "bull_summary", "bear_summary", "reference_bid",
...
_EVALUATION_COLUMNS = {
    ...
    "future_spread_points", "point", "digits", "buy_net_price", "buy_net_points", "sell_net_price",
    "sell_net_points", "selected_action", "selected_action_net_price", "selected_action_net_points",
    "best_counterfactual_action", "best_counterfactual_net_points", "hold_opportunity_cost_points",
    "buy_mfe_price", "buy_mfe_points", "buy_mae_price", "buy_mae_points", "sell_mfe_price",
    "sell_mfe_points", "sell_mae_price", "sell_mae_points", "evaluation_status", "unavailable_reason",
    "created_at", "evaluated_at", "recovered_from_unavailable_at", "previous_unavailable_reason",
}
...
class ReadonlySourceReader:
    ...
    @staticmethod
    def _require(schema: dict[str, Any], table: str, columns: set[str], *, required: bool = True) -> None:
    ...
    def _rows(self, connection: sqlite3.Connection, table: str, order: str) -> tuple[dict[str, Any], ...]:
    ...
    def read_snapshot(self) -> ReadonlySourceSnapshot:
        ...
        metadata = {"schema": schema, "decisions": decisions, "evaluations": evaluations, "watcher_runs": runs, "watcher_opportunities": opportunities, "watcher_state": state}
        return ReadonlySourceSnapshot(schema, before_file, before_wal, decisions, evaluations, runs, opportunities, state, self.sqlite_uri, str(self.path), observed, source_snapshot_fingerprint(metadata))

    ...
    def plan(source, topics, config: PlannerConfig | None = None) -> SourcePlan:
        ...
        while i<len(selected):
            ...
            while i<len(selected) and len(group)<config.max_blocks:
                ...
                same = candidate.ref.document_id==first.ref.document_id and candidate.ref.section==first.ref.section
        ...
        return SourcePlan(source.generation_id,tuple(packets),fp,tuple(diagnostics))
